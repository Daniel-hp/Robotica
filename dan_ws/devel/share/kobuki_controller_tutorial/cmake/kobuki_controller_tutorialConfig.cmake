...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /home/dan-hp/Robotica/dan_ws/src/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /home/dan-hp/Robotica/dan_ws/devel)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/dan-hp/Robotica/dan_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dan-hp <dan-hp@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dan-hp/Robotica/dan_ws/src/kobuki_controller_tutorial/${idir}'.  Ask the maintainer 'dan-hp <dan-hp@todo.todo>' to fix it.")
    endif()
