...
struct Num_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _Amr_type;
  _Amr_type Amr;
...
// {'beginner_tutorials': ['/home/dan-hp/Robotica/dan_ws/src/beginner_tutorials/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::beginner_tutorials::Num_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x41627bb8959d7ae8ULL;
  static const uint64_t static_value2 = 0x5c352700984f35ccULL;
};
...
struct Printer< ::beginner_tutorials::Num_<ContainerAllocator> >
{
  ...
  {
    s << indent << "Amr: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.Amr);
  }
};
